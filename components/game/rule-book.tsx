          ...
          <div className="p-4 space-y-3">
            {rules.length === 0 ? (
              <div className="text-center py-10 px-4 border-2 border-dashed border-border rounded-lg">
                ...
                <p className="text-muted-foreground text-sm">Aucune règle active.</p>
                <Button variant="link" onClick={onAddRule} className="text-cyan-400 mt-2">
                  Créez-en une !
                </Button>
              </div>
            ) : (
